...
// //     setMediaProgress(true); // Start progress indicator
...
// //           publicId: res.data.data.public_id,
// //         });
// //         setBtnDisable(false); // Enable save button
...
// //     } finally {
// //       setMediaProgress(false); // End progress indicator
// //     }
// //   }
// // };
...
// //     console.log({
// //       lectureTitle,
// //     //   videoInfo: uploadVideInfo, // Ensure this contains videoUrl and publicId
// //     videoInfo:uploadVideInfo,
// //       isPreviewFree: isFree,
// //       courseId,
// //       lectureId,
...
//   const [isFree, setIsFree] = useState(false);
//   const [mediaProgress, setMediaProgress] = useState(false);
//   const [uploadProgress, setUploadProgress] = useState(0); // Initialize upload progress
//   const [btnDisable, setBtnDisable] = useState(true);
//   const params = useParams();
//   const { courseId, lectureId } = params;
...
const LectureTab = () => {
  ...
  // Success/Error Handling via useEffect
  useEffect(() => {
    if (isSuccess) {
      toast.success(data.message);
    }
