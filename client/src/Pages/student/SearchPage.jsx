...
const SearchPage = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto p-4 md:p-8 mt-10 bg-gray-50 dark:bg-[#020817] text-gray-800 dark:text-gray-200">
      <div className="my-6">
...
const CourseNotFound = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-32 bg-gray-100 dark:bg-[#020817] p-6 rounded-lg shadow-lg">
      <AlertCircle className="text-red-500 h-16 w-16 mb-4" />
      <h1 className="font-bold text-2xl md:text-4xl text-gray-800 dark:text-gray-200 mb-2">
        Course Not Found
      </h1>
...
const CourseSkeleton = () => {
  return (
    <div className="flex-1 flex flex-col md:flex-row justify-between border-b border-gray-300 dark:border-gray-700 py-4">
      <div className="h-32 w-full md:w-64 bg-gray-200 dark:bg-gray-700">
        <Skeleton className="h-full w-full object-cover" />
      </div>
      ...
      <div className="flex flex-col gap-2 flex-1 px-4">
        ...
        <Skeleton className="h-6 w-20 mt-2 bg-gray-300 dark:bg-gray-600" />
      </div>

      <div className="flex flex-col items-end justify-between mt-4 md:mt-0">
        <Skeleton className="h-6 w-12 bg-gray-300 dark:bg-gray-600" />
      </div>
    </div>
  );
};
